...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            <img src="{{ asset('assets_home') }}/img/logo_asfiyahi2.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">LES FIDÈLES DE ASFIYAHI</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'gallery' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-image ps-2 pe-2 text-center"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'subscriptions' ? ' active bg-gradient-primary' : '' }} "
